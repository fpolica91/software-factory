...
/// Host-provided callback that appends contributors to app-server's native
/// Codex extension registry.
pub type AppServerExtensionInstaller =
    Arc<dyn Fn(&mut codex_extension_api::ExtensionRegistryBuilder<Config>) + Send + Sync>;
...
pub async fn run_main(
    ...
    run_main_with_extension_installers(
        arg0_paths,
...
/// Runs the standard stdio app-server lifecycle with additional native Codex
/// extension contributors installed after the built-in contributors.
pub async fn run_main_with_extension_installers(
    arg0_paths: Arg0DispatchPaths,
    cli_config_overrides: CliConfigOverrides,
    loader_overrides: LoaderOverrides,
    strict_config: bool,
    default_analytics_enabled: bool,
    extension_installers: Vec<AppServerExtensionInstaller>,
) -> IoResult<()> {
    run_main_with_extension_installers_and_runtime_options(
        arg0_paths,
        cli_config_overrides,
        loader_overrides,
        strict_config,
...
/// Runs the standard stdio app-server lifecycle with additional native Codex
/// extension contributors and explicit runtime-only startup behavior.
pub async fn run_main_with_extension_installers_and_runtime_options(
    arg0_paths: Arg0DispatchPaths,
    cli_config_overrides: CliConfigOverrides,
    loader_overrides: LoaderOverrides,
    strict_config: bool,
    ...
    run_main_with_transport_options_and_extension_installers(
        arg0_paths,
        cli_config_overrides,
        loader_overrides,
        strict_config,
...
#[allow(clippy::too_many_arguments)]
async fn run_main_with_transport_options_and_extension_installers(
    arg0_paths: Arg0DispatchPaths,
    cli_config_overrides: CliConfigOverrides,
    loader_overrides: LoaderOverrides,
    strict_config: bool,
